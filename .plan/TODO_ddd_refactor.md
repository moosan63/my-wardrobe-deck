...
### 作業内容
- [ ] `app/src/item/repositories/item-repository.ts` - Writeリポジトリインターフェース
- [ ] `app/src/item/repositories/item-read-repository.ts` - Readリポジトリインターフェース
- [ ] `app/infrastructure/d1/item-repository-impl.ts` - D1 Writeリポジトリ実装
- [ ] `app/infrastructure/d1/item-read-repository-impl.ts` - D1 Readリポジトリ実装
- [ ] リポジトリ統合テスト
...
### 作業内容
- [ ] `app/src/item/usecases/create-item.ts` - アイテム作成
...
- [ ] `app/src/item/index.ts` - エクスポート
- [ ] ユースケース単体テスト（リポジトリモック使用）
